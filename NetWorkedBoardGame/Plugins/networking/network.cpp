...
int Network::nSendColorEvent(float r, float g, float b)
{
	...
	return peer->Send(reinterpret_cast<char*>(&colorEvent), sizeof(colorEvent)*10, HIGH_PRIORITY, RELIABLE_ORDERED, 0, peer->GetGuidFromSystemAddress(RakNet::UNASSIGNED_SYSTEM_ADDRESS), true);
}
...
int Network::nSendDirectionEvent(int x)
{
	...
	//send message
	return peer->Send(reinterpret_cast<char*>(&dirEvent), sizeof(dirEvent)*10, HIGH_PRIORITY, RELIABLE_ORDERED, 0, peer->GetGuidFromSystemAddress(RakNet::UNASSIGNED_SYSTEM_ADDRESS), true);
}
...
int Network::nSendMessageEvent(char* message, int bufferSize)
{
	...
	return peer->Send(reinterpret_cast<char*>(&messEvent), sizeof(messEvent)*10, HIGH_PRIORITY, RELIABLE_ORDERED, 0, peer->GetGuidFromSystemAddress(RakNet::UNASSIGNED_SYSTEM_ADDRESS), true);
}
...
int Network::nSpeedEvent(float speed)
{
	...
	return peer->Send(reinterpret_cast<char*>(&spdEvent), sizeof(spdEvent)*10, HIGH_PRIORITY, RELIABLE_ORDERED, 0, peer->GetGuidFromSystemAddress(RakNet::UNASSIGNED_SYSTEM_ADDRESS), true);
}
